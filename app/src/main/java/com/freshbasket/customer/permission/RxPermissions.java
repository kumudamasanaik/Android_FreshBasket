package com.freshbasket.customer.permission;
...
public class RxPermissions {
     ...
     * permission also will be granted. If any permission has {@code shouldShowRationale} checked, than customerData also has it checked.
     * <p>
     * If one or several permissions have never been requested, invoke the related framework method
     * to ask the user if he allows the permissions.
     */
